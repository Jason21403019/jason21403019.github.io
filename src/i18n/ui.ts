...
export const ui = {
  'zh-Hant': {
    ...
    'hero.greeting': '你好，我是',
    'hero.name': '哲菘',
    'hero.tagline': '軟體工程師 · 作品集',
    'hero.intro':
      '這裡整理了我在工作期間開發與維護的專案。歡迎點開每個專案了解更多。（這段自我介紹之後可在 src/i18n/ui.ts 修改。）',

    'section.current.title': '現職作品',
    'section.current.desc': '目前任職期間開發與維護的專案。',
    'section.previous.title': '轉職前作品',
    'section.previous.desc': '轉職進入軟體開發之前完成的作品。',
  ...
  en: {
    ...
    'section.previous.desc':
      'Work completed before moving into software development.',

    'card.role': 'Role',
    'card.tech': 'Tech',
    'card.empty':
      'No projects here yet — add a .md file under src/content/projects/.',
